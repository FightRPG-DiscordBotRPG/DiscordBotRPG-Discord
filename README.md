...
- You must have installed: `https://github.com/FightRPG-DiscordBotRPG/DiscordBotRPG-Server` before going further

### Clone

- Clone this repo to your local machine using `https://github.com/FightRPG-DiscordBotRPG/DiscordBotRPG-Discord.git`
