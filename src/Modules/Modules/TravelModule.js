...
class TravelModule extends GModule {
    ...
    getTravelMessage(data) {
        return new Discord.RichEmbed()
            ...
            .addField(Translator.getString(data.lang, "travel", "wait_time_title"), Translator.getString(data.lang, "travel", "wait_time_body", [data.realWaitTime, data.costs.timeToWait - data.realWaitTime]), true)
